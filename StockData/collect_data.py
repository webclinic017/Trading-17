...
for sym in Symbols:
    ...
    temp = pd.read_csv("C:\\Users\\Burge\\Desktop\\StockData\\{}_5Min".format(sym), index_col=0, parse_dates=True)
    ...
    df.to_csv('C:\\Users\\Burge\\Desktop\\StockData\\{}_5Min'.format(sym))
